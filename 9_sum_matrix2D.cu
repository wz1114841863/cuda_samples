...
int main() {
    ...
    std::cout << "CPU Execution Time elapsed " << iElaps << " sec." << std::endl;
    ...
    std::cout << "GPU Execution configuration<<<(" << grid_0.x << ", " << grid_0.y <<
        "), (" << block_0.x << ", " <<block_0.y <<")>>>, Time elapsef " << iElaps << "sec." << std::endl;
